...
public class LeaveListSearchValidation extends CommonMethods {
...
//	Close browser
	...
	public static void main(String[] args) {
		...
		for (int i=1; i<rows.size(); i++) {
			...
			driver.findElement(By.id("ctl00_MainContent_fmwOrder_txtName")).sendKeys("Susan Smith");
		...
		for(int i=1; i<rows2.size(); i++) {
			...
			//System.out.println(rowText);
			if(rowText.contains("Susan Smith") && rowText.contains("0012567890")) {
